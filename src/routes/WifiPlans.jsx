...
const DomeCard = ({ plan, color, index, onSelect, darkMode }) => {
  const colorMap = {
    ...
    red: {
      bg: "linear-gradient(135deg, #676c77 0%, #4b5563 100%)",
      button: BUTTON_STYLES.small.light,
    },
    goldenYellow: {
      bg: "linear-gradient(135deg, #303a4d 0%, #4b5563 100%)",
      button: BUTTON_STYLES.small.light,
    },
    goldenGreen: {
      bg: "linear-gradient(135deg, #303a4d 0%, #676c77 100%)",
      button: BUTTON_STYLES.small.light,
    },
    purple: {
      bg: "linear-gradient(135deg, #303a4d 0%, #525866 100%)",
      button: BUTTON_STYLES.small.light,
    },
    pink: {
      bg: "linear-gradient(135deg, #676c77 0%, #525866 100%)",
      button: BUTTON_STYLES.small.light,
    }
  };
  ...
  return (
    <motion.div 
      ...
      animate={controls}
      className={`vuma-card rounded-lg overflow-hidden relative h-full flex flex-col group`}
      whileHover={{ y: -5 }}
    >
      {plan.popular && (
      ...
      <div className="flex-grow flex flex-col bg-white">
        ...
        <div className="pt-4 pb-4 px-4">
          <div className="text-center mb-3">
            <span className="text-xl font-bold text-primary">Ksh {plan.price}</span>
...
const MobileHotspotCard = ({ plan, color, index, onSelect, darkMode }) => {
  const colorMap = {
    teal: {
      bg: darkMode ? "linear-gradient(135deg, #303a4d 0%, #434a57 100%)" : "linear-gradient(135deg, #303a4d 0%, #434a57 100%)",
      button: darkMode ? BUTTON_STYLES.small.dark : BUTTON_STYLES.small.light,
    },
    amber: {
      bg: darkMode ? "linear-gradient(135deg, #676c77 0%, #525866 100%)" : "linear-gradient(135deg, #676c77 0%, #525866 100%)",
      button: BUTTON_STYLES.small.light,
    },
    violet: {
      bg: darkMode ? "linear-gradient(135deg, #303a4d 0%, #4b5563 100%)" : "linear-gradient(135deg, #303a4d 0%, #4b5563 100%)",
      button: BUTTON_STYLES.small.light,
    },
    rose: {
      bg: darkMode ? "linear-gradient(135deg, #676c77 0%, #4b5563 100%)" : "linear-gradient(135deg, #676c77 0%, #4b5563 100%)",
      button: BUTTON_STYLES.small.light,
    },
    emerald: {
      bg: darkMode ? "linear-gradient(135deg, #303a4d 0%, #5b6371 100%)" : "linear-gradient(135deg, #303a4d 0%, #5b6371 100%)",
      button: BUTTON_STYLES.small.light,
    },
    blue: {
      bg: darkMode ? "linear-gradient(135deg, #303a4d 0%, #676c77 100%)" : "linear-gradient(135deg, #303a4d 0%, #676c77 100%)",
      button: BUTTON_STYLES.small.light,
    }
  };
