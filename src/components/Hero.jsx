...
        {/* 1. Package Name (Small, Uppercase) */}
        <h3 className="relative z-10 text-sm font-bold tracking-wider uppercase mb-1 opacity-90 text-white/80">{plan.name}</h3>
        
        <div className="relative z-10 text-center drop-shadow-lg">
            {/* 2. Speed (Large, White, Bold) */}
            <p className="text-5xl font-black tracking-tighter text-white leading-none">
                {plan.speed}<span className="text-xl font-bold ml-1">{plan.unit}</span>
            </p>

            {/* 3. Price (Large, White, Bold) */}
            <p className="text-3xl font-extrabold text-white">
                Ksh {plan.price}<span className="text-xl font-medium text-white/80"> / month</span>
            </p>
        </div>
